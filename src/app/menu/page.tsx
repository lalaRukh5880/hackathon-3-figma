    ...
    <div className='bg-black-2'>
        <div className='w-full h-[250px] flex justify-center items-center'>
            <div className='w-[80%] flex justify-between gap-[40px] items-center text-white px-10 md:lg:px-20'>
                <div className='flex justify-between gap-[20px] w-full border border-white max-sm:grid max-sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3'>
